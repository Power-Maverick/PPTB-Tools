    ...
    <section className={styles.panel}>
      <header className={styles.header}>
        <div>
          ...
          <h2>
            Create, test, and ship your PCF controls from a single workspace.
          </h2>
        </div>
      ...
      <div className={styles.grid}>
        <div>
          ...
          <input
            ...
            placeholder="Contoso"
            onChange={(event) =>
              onControlChange({ namespace: event.target.value })
            }
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(event) =>
              onControlChange({ displayName: event.target.value })
            }
          />
        </div>
        <div>
          ...
          <input
            ...
            placeholder="1.0.0"
            onChange={(event) =>
              onControlChange({ version: event.target.value })
            }
          />
        </div>
      </div>
            ...
            onChange={(event) =>
              onControlChange({
                controlType: event.target
                  .value as PCFControlConfig["controlType"],
              })
            }
          >
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(event) =>
            onControlChange({ description: event.target.value })
          }
        />
      </div>
      ...
      <div>
        ...
        <p className={styles.helperText}>
          Packages are added via <code>--npm-packages</code> during control
          init.
        </p>
      </div>
