...
export function AssetDetails({ selectedAsset, allAssets }: AssetDetailsProps) {
  ...
  const dependenciesAssets = selectedAsset.linksTo
    .map(id => allAssets.find(a => a.assetId === id))
    .filter((a): a is Asset => a !== undefined);

  const dependentsAssets = (selectedAsset.linkedBy || [])
    .map(id => allAssets.find(a => a.assetId === id))
    .filter((a): a is Asset => a !== undefined);
    ...
    <div className="details-panel">
      ...
      <div className="details-section">
        ...
        <dl className="info-list">
          ...
          <dt>Asset ID:</dt>
          <dd className="mono-text">{selectedAsset.assetId}</dd>
          ...
          <dd>
            ...
            {!selectedAsset.notFound && !selectedAsset.hasLoop && <span className="status-ok">✓ OK</span>}
          </dd>
        </dl>
      </div>
